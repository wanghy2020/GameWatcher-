...
public class HttpPost implements Serializable {
    private static final long serialVersionUID = 3589301174941610822L;

    public JSONObject sendRequest(String url, String param){
        ...
        try {
            ...
            log.error("发送Post请求出错，错误信息为{}",e.getMessage());
        } finally{
            try{
                if(out!=null){
                    out.close();
